...
<body>
    <div class="container">
        ...
        <div class="share-grid">
            <div class="ip-banner-container">
                <div class="ip-banner">
                    <div style="font-size: 0.8rem; text-transform: uppercase; opacity: 0.6; margin-bottom: 0.4rem;">Network Address</div>
                    http://<!-- IP_PLACEHOLDER -->:<!-- PORT_PLACEHOLDER -->
                </div>
                <p style="color: var(--text-muted); font-size: 0.95rem; margin: 0; padding: 0 0.5rem;">
                    Other devices on your Wi-Fi can access this server using the link or QR code.
                </p>
            </div>
            <div class="qr-card">
                ...
                <div class="qr-label">Quick Connect</div>
            </div>
        </div>
    ...
    <script>
        ...
        const serverUrl = 'http://<!-- IP_PLACEHOLDER -->:<!-- PORT_PLACEHOLDER -->';
        const qr = new QRious({
            element: document.getElementById('qr-canvas'),
            value: serverUrl,
            size: 280, // Higher resolution for better scanning
            background: 'white',
            foreground: '#0f172a',
            level: 'M'
        });
...
"@
                    ...
                    $finalHtml = $finalHtml -replace "<!-- QR_JS_PLACEHOLDER -->", $qrCodeJs
